    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="配件类型" prop="peijianleixing">
          <el-select :disabled="ro.peijianleixing" v-model="ruleForm.peijianleixing" placeholder="请选择配件类型">
            <el-option
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="配件简介" prop="peijianjianjie">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.peijianjianjie" label="配件简介" prop="peijianjianjie">
                    <span v-html="ruleForm.peijianjianjie"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.peijianjianjie = this.ruleForm.peijianjianjie.replace(reg,'../../../ssm391lx/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
