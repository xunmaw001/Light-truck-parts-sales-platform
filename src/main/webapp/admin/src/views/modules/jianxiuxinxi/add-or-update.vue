<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="检修时间" prop="jianxiushijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.jianxiushijian" 
                type="datetime"
                :readonly="ro.jianxiushijian"
                placeholder="检修时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jianxiushijian" label="检修时间" prop="jianxiushijian">
              <el-input v-model="ruleForm.jianxiushijian" 
                placeholder="检修时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  ...
  created() {
	this.ruleForm.jianxiushijian = this.getCurDateTime()
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jianchaqingkuang = true;
          ...
          if(o=='jianxiushijian'){
            this.ruleForm.jianxiushijian = obj[o];
	    this.ro.jianxiushijian = true;
            continue;
          }
        }
      }
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `jianxiuxinxi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.jianxiuxinxiCrossAddOrUpdateFlag = false;
						 this.parent.search();
