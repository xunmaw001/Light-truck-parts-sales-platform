<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="配件名称" prop="peijianmingcheng">
          <el-select :disabled="ro.peijianmingcheng" v-model="ruleForm.peijianmingcheng" placeholder="请选择配件名称">
            <el-option
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="售后登记" prop="shouhoudengji">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="售后登记"
                  v-model="ruleForm.shouhoudengji" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.shouhoudengji" label="售后登记" prop="shouhoudengji">
                    <span>{{ruleForm.shouhoudengji}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shuliang = true;
          ...
          if(o=='shouhoudengji'){
            this.ruleForm.shouhoudengji = obj[o];
	    this.ro.shouhoudengji = true;
            continue;
          }
          if(o=='dengjishijian'){
