...
public class ShouhouxinxiVO  implements Serializable {
	...
	public void setShouhoudengji(String shouhoudengji) {
		this.shouhoudengji = shouhoudengji;
	}
	
	/**
	 * 获取：售后登记
	 */
	public String getShouhoudengji() {
		return shouhoudengji;
	}
